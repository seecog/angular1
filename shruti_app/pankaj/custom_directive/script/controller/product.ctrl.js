...
$scope.editPro = function(product){
...
{
$scope.products[i].contact.name = product.contact.name;
$scope.products[i].contact.phone = product.contact.phone;
$scope.products[i].contact.email = product.contact.email;
}
}
